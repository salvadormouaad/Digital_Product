...
import Bg from "../assets/14827 1.png";
      ...
      <div className='container mx-auto px-4 py-12'>
        <div className='max-w-6xl mx-auto bg-opacity-10  rounded-lg p-8 md:p-12 bg-'>
          <div className='text-center mb-12'>
            <h1 className='text-4xl md:text-5xl font-bold text-white mb-4'>We Are Here <span className='text-[#FBB041]'>For You!</span> </h1>
            ...
            <div className='text-white'>
              ...
              <div className='mt-8'>
                ...
                <div className='flex space-x-4'>
                  ...
                  <a href="#" className='bg-[#242626] hover:bg-blue-400 p-3 rounded-full transition duration-300'>
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
