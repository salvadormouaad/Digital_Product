            ...
            <div className='text-white'>
              ...
              <div className='mt-8'>
                ...
                <div className='flex space-x-4'>
                  <a href="https://www.facebook.com/profile.php?id=61580833838802" target='blank' className='bg-[#242626] hover:bg-blue-600 p-3 rounded-full transition duration-300'>
